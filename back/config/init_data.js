...
async function initData() {
    try {
        ...
        const proyectos = [
            ...
            {
                titulo: 'Generador Mágico',
                descripcion: 'Aplicación web desarrollada en CSS y JavaScript. Generador de contenido o herramientas con interfaz moderna y funcional.',
                tecnologias: ['CSS', 'JavaScript', 'HTML'],
                imagen: 'assets/images/proyecto-generador.jpg',
                url_demo: '',
                url_repositorio: 'https://github.com/elmonokl/generador-magico',
                fecha: new Date('2025-11-13'),
                categoria: 'Web Development',
                rol: 'Desarrollador Frontend',
                resultados: 'Generador funcional con diseño moderno.',
                caracteristicas: [
                    'Interfaz moderna',
